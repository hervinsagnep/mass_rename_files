...
*1. INPUT NEEDS TO BE PUT FOR ALL FUNCTIONS THAT HAVE MONTHS IN TEMPLATE
*FIXED WITH MANUALLY INPUTTING YEAR AS "2018" IN EACH VARIABLE

2. USER INPUT FOR MONTH WILL ASK FOR INPUT OF EACH INDIVIDUAL FILE, NEED INPUT TO FORMAT WITH THE SINGLE INPUT INTEGER
